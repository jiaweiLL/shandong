...
def crc_update(crc, data):
    ...
    :param crc: 32-bit checksum to update as long.
    :param data: byte array, string or iterable over bytes.
    :returns: 32-bit updated CRC-32C as long.
    """
...
def crc_finalize(crc):
    ...
    :param crc: 32-bit checksum as long.

    :returns: finalized 32-bit checksum as long.
    """
    return crc & _MASK
...
def _crc32c(data):
    ...
    :param data: byte array, string or iterable over bytes.
    :returns: 32-bit CRC-32C checksum of data as long.
    """
