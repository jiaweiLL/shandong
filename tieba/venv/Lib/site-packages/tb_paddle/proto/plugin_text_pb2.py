...
# source: tb_paddle/proto/plugin_text.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tb_paddle/proto/plugin_text.proto',
  package='tb_paddle',
  syntax='proto3',
...
_TEXTPLUGINDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='tb_paddle.TextPluginData.version', index=0,
...
TextPluginData = _reflection.GeneratedProtocolMessageType('TextPluginData', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:tb_paddle.TextPluginData)
  })
