...
# source: tb_paddle/proto/event.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tb_paddle/proto/event.proto',
  package='tb_paddle',
  syntax='proto3',
  serialized_options=_b('\n\023org.tensorflow.utilB\013EventProtosP\001\370\001\001'),
  serialized_pb=_b('\n\x1btb_paddle/proto/event.proto\x12\ttb_paddle\x1a\x1dtb_paddle/proto/summary.proto\"\xb7\x02\n\x05\x45vent\x12\x11\n\twall_time\x18\x01 \x01(\x01\x12\x0c\n\x04step\x18\x02 \x01(\x03\x12\x16\n\x0c\x66ile_version\x18\x03 \x01(\tH\x00\x12\x13\n\tgraph_def\x18\x04 \x01(\x0cH\x00\x12%\n\x07summary\x18\x05 \x01(\x0b\x32\x12.tb_paddle.SummaryH\x00\x12,\n\x0blog_message\x18\x06 \x01(\x0b\x32\x15.tb_paddle.LogMessageH\x00\x12,\n\x0bsession_log\x18\x07 \x01(\x0b\x32\x15.tb_paddle.SessionLogH\x00\x12;\n\x13tagged_run_metadata\x18\x08 \x01(\x0b\x32\x1c.tb_paddle.TaggedRunMetadataH\x00\x12\x18\n\x0emeta_graph_def\x18\t \x01(\x0cH\x00\x42\x06\n\x04what\"\x94\x01\n\nLogMessage\x12*\n\x05level\x18\x01 \x01(\x0e\x32\x1b.tb_paddle.LogMessage.Level\x12\x0f\n\x07message\x18\x02 \x01(\t\"I\n\x05Level\x12\x0b\n\x07UNKNOWN\x10\x00\x12\t\n\x05\x44\x45\x42UG\x10\n\x12\x08\n\x04INFO\x10\x14\x12\x08\n\x04WARN\x10\x1e\x12\t\n\x05\x45RROR\x10(\x12\t\n\x05\x46\x41TAL\x10\x32\"\xb5\x01\n\nSessionLog\x12\x33\n\x06status\x18\x01 \x01(\x0e\x32#.tb_paddle.SessionLog.SessionStatus\x12\x17\n\x0f\x63heckpoint_path\x18\x02 \x01(\t\x12\x0b\n\x03msg\x18\x03 \x01(\t\"L\n\rSessionStatus\x12\x16\n\x12STATUS_UNSPECIFIED\x10\x00\x12\t\n\x05START\x10\x01\x12\x08\n\x04STOP\x10\x02\x12\x0e\n\nCHECKPOINT\x10\x03\"6\n\x11TaggedRunMetadata\x12\x0b\n\x03tag\x18\x01 \x01(\t\x12\x14\n\x0crun_metadata\x18\x02 \x01(\x0c\x42\'\n\x13org.tensorflow.utilB\x0b\x45ventProtosP\x01\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[tb__paddle_dot_proto_dot_summary__pb2.DESCRIPTOR,])



_LOGMESSAGE_LEVEL = _descriptor.EnumDescriptor(
  name='Level',
  full_name='tb_paddle.LogMessage.Level',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SESSIONLOG_SESSIONSTATUS = _descriptor.EnumDescriptor(
  name='SessionStatus',
  full_name='tb_paddle.SessionLog.SessionStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_EVENT = _descriptor.Descriptor(
  name='Event',
  full_name='tb_paddle.Event',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='wall_time', full_name='tb_paddle.Event.wall_time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='step', full_name='tb_paddle.Event.step', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='file_version', full_name='tb_paddle.Event.file_version', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='graph_def', full_name='tb_paddle.Event.graph_def', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='summary', full_name='tb_paddle.Event.summary', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log_message', full_name='tb_paddle.Event.log_message', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='session_log', full_name='tb_paddle.Event.session_log', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tagged_run_metadata', full_name='tb_paddle.Event.tagged_run_metadata', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='meta_graph_def', full_name='tb_paddle.Event.meta_graph_def', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='what', full_name='tb_paddle.Event.what',
...
_LOGMESSAGE = _descriptor.Descriptor(
  name='LogMessage',
  full_name='tb_paddle.LogMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='level', full_name='tb_paddle.LogMessage.level', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='message', full_name='tb_paddle.LogMessage.message', index=1,
...
_SESSIONLOG = _descriptor.Descriptor(
  name='SessionLog',
  full_name='tb_paddle.SessionLog',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='tb_paddle.SessionLog.status', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='checkpoint_path', full_name='tb_paddle.SessionLog.checkpoint_path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='msg', full_name='tb_paddle.SessionLog.msg', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TAGGEDRUNMETADATA = _descriptor.Descriptor(
  ...
  full_name='tb_paddle.TaggedRunMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tag', full_name='tb_paddle.TaggedRunMetadata.tag', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='run_metadata', full_name='tb_paddle.TaggedRunMetadata.run_metadata', index=1,
...
_EVENT.fields_by_name['summary'].message_type = tb__paddle_dot_proto_dot_summary__pb2._SUMMARY
...
Event = _reflection.GeneratedProtocolMessageType('Event', (_message.Message,), {
  'DESCRIPTOR' : _EVENT,
  '__module__' : 'tb_paddle.proto.event_pb2'
  # @@protoc_insertion_point(class_scope:tb_paddle.Event)
  })
...
LogMessage = _reflection.GeneratedProtocolMessageType('LogMessage', (_message.Message,), {
  ...
  '__module__' : 'tb_paddle.proto.event_pb2'
  # @@protoc_insertion_point(class_scope:tb_paddle.LogMessage)
  })
...
SessionLog = _reflection.GeneratedProtocolMessageType('SessionLog', (_message.Message,), {
  ...
  '__module__' : 'tb_paddle.proto.event_pb2'
  # @@protoc_insertion_point(class_scope:tb_paddle.SessionLog)
  })
...
TaggedRunMetadata = _reflection.GeneratedProtocolMessageType('TaggedRunMetadata', (_message.Message,), {
  ...
  '__module__' : 'tb_paddle.proto.event_pb2'
  # @@protoc_insertion_point(class_scope:tb_paddle.TaggedRunMetadata)
  })
