...
# source: tb_paddle/proto/plugin_mesh.proto
...
MeshPluginData = _reflection.GeneratedProtocolMessageType('MeshPluginData', (_message.Message,), {
  ...
  '__module__' : 'tb_paddle.proto.plugin_mesh_pb2'
