...
# source: tb_paddle/proto/versions.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tb_paddle/proto/versions.proto',
  package='tb_paddle',
  syntax='proto3',
...
_VERSIONDEF = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='producer', full_name='tb_paddle.VersionDef.producer', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='min_consumer', full_name='tb_paddle.VersionDef.min_consumer', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bad_consumers', full_name='tb_paddle.VersionDef.bad_consumers', index=2,
...
VersionDef = _reflection.GeneratedProtocolMessageType('VersionDef', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:tb_paddle.VersionDef)
  })
